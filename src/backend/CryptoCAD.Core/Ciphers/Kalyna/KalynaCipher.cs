...
namespace CryptoCAD.Core.Ciphers.Kalyna
{
    internal class KalynaCipher : ICipher
    {
        private byte[][] mds_matrix = new byte[8][]
        {
            new byte[8] {0x01, 0x01, 0x05, 0x01, 0x08, 0x06, 0x07, 0x04},
            new byte[8] {0x04, 0x01, 0x01, 0x05, 0x01, 0x08, 0x06, 0x07},
            new byte[8] {0x07, 0x04, 0x01, 0x01, 0x05, 0x01, 0x08, 0x06},
            new byte[8] {0x06, 0x07, 0x04, 0x01, 0x01, 0x05, 0x01, 0x08},
            new byte[8] {0x08, 0x06, 0x07, 0x04, 0x01, 0x01, 0x05, 0x01},
            new byte[8] {0x01, 0x08, 0x06, 0x07, 0x04, 0x01, 0x01, 0x05},
            new byte[8] {0x05, 0x01, 0x08, 0x06, 0x07, 0x04, 0x01, 0x01},
            new byte[8] {0x01, 0x05, 0x01, 0x08, 0x06, 0x07, 0x04, 0x01}
        };
        private byte[][] mds_inv_matrix = new byte[8][]
        {
            new byte[8] {0xAD, 0x95, 0x76, 0xA8, 0x2F, 0x49, 0xD7, 0xCA},
            new byte[8] {0xCA, 0xAD, 0x95, 0x76, 0xA8, 0x2F, 0x49, 0xD7},
            new byte[8] {0xD7, 0xCA, 0xAD, 0x95, 0x76, 0xA8, 0x2F, 0x49},
            new byte[8] {0x49, 0xD7, 0xCA, 0xAD, 0x95, 0x76, 0xA8, 0x2F},
            new byte[8] {0x2F, 0x49, 0xD7, 0xCA, 0xAD, 0x95, 0x76, 0xA8},
            new byte[8] {0xA8, 0x2F, 0x49, 0xD7, 0xCA, 0xAD, 0x95, 0x76},
            new byte[8] {0x76, 0xA8, 0x2F, 0x49, 0xD7, 0xCA, 0xAD, 0x95},
            new byte[8] {0x95, 0x76, 0xA8, 0x2F, 0x49, 0xD7, 0xCA, 0xAD}
        };
        private byte[][] sboxes_enc = new byte[4][]
        {
            new byte[256] {
        ...
        private byte[][] sboxes_dec = new byte[4][]
        {
            new byte[256] {
