    ...
    public class MethodsRepositoryTests
    {
        ...
        public void InitData(string fileName)
        {
            ...
            try
            {
                ...
                Assert.AreEqual(MethodTypes.Cipher.ToFriendlyString(), desEntity.Type);
                ...
                Assert.AreEqual(MethodTypes.Cipher.ToFriendlyString(), aesEntity.Type);
                ...
                Assert.AreEqual(MethodTypes.Cipher.ToFriendlyString(), gostEntity.Type);
                ...
                Assert.AreEqual(MethodTypes.Hash.ToFriendlyString(), sha156Entity.Type);
                ...
                Assert.AreEqual(MethodTypes.Cipher.ToFriendlyString(), desTemplateEntity.Type);
                Assert.IsTrue(desTemplateEntity.IsModifiable);
